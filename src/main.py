...
def __main__():
    # Initialize import variables & prompt user for desired number of teams, which week is rivalry week
    ...
    # Prompt user for names of all teams
